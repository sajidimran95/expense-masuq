        ...
        <div class="card expense-card">
            <div class="card-header border-0 bg-white">
                <div class="d-flex flex-column flex-md-row justify-content-between gap-3">
                    <div>
                        <h3 class="card-title fw-bold">Staff আপডেট করুন</h3>
                        <p class="text-secondary mb-0">Password blank রাখলে আগের password থাকবে।</p>
                    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-switch mt-2">
                            ...
                            <input type="checkbox" name="is_active" value="1" class="form-check-input" id="is_active" @checked(old('is_active', $staff->is_active))>
                        ...
                        @foreach ($permissions as $key => $label)
                            <div class="col-md-6">
                                <label class="permission-card">
                                    <input type="checkbox" name="permissions[]" value="{{ $key }}" @checked(in_array($key, old('permissions', $staff->permissions ?? []), true))>
                                    <span>{{ $label }}</span>
                                </label>
                            </div>
                        @endforeach
